...
class Iconic_WSSV_Core_Settings {
	...
	public static function hide_notices() {
		$hide_notice = filter_input( INPUT_GET, 'iconic-wssv-hide-notice' );
	...
	public static function output_getting_started_links() {
		...
		<ol>
			<?php foreach ( $links as $link ) { ?>
				<li>
					<a href="<?php echo esc_url( self::get_docs_url() . $link['href'] ); ?>?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=getting-started-links" target="_blank"><?php echo esc_html( $link['title'] ); ?></a>
				</li>
			<?php } ?>
		</ol>
		<?php
		...
		if ( current_user_can( 'manage_options' ) && ! defined( 'ICONIC_DISABLE_DASH' ) && ! defined( 'ICONIC_WSSV_DISABLE_DASH' ) ) {
			$settings['sections']['licence'] = array(
				...
				'fields'              => array(
					array(
						'id'       => 'licence',
						'title'    => esc_html__( 'License &amp; Billing', 'iconic-wssv' ),
						'subtitle' => esc_html__( 'Activate or sync your license, cancel your subscription, print invoices, and manage your account information.', 'iconic-wssv' ),
						'type'     => 'custom',
						'output'   => Iconic_WSSV_Core_Licence::admin_account_link(),
					),
					array(
						'id'       => 'account',
						'title'    => esc_html__( 'Your Account', 'iconic-wssv' ),
						'subtitle' => esc_html__( 'Manage all of your Iconic plugins, supscriptions, renewals, and more.', 'iconic-wssv' ),
						'type'     => 'custom',
					...
					<?php foreach ( $cross_sells as $cross_sell ) { ?>
						<div class="iconic-product">
							...
							<div class="iconic-product__content">
								<h4 class="iconic-product__title"><a target="_blank" href="<?php echo esc_url( $cross_sell['link'] ); ?>?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=cross-sell" target="_blank"><?php echo wp_kses_post( $cross_sell['title']['rendered'] ); ?></a></h4>
	...
	public static function support_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/support/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=support-link', esc_html__( 'Submit Ticket', 'iconic-wssv' ) );
	}
	...
	public static function documentation_link() {
		return sprintf( '<a href="%s?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=documentation-link" class="button button-secondary" target="_blank">%s</a>', self::get_docs_url( 'collection' ), esc_html__( 'Read Documentation', 'iconic-wssv' ) );
	}
	...
	public static function account_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/account/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=account-link', esc_html__( 'Manage Your Account', 'iconic-wssv' ) );
	}
