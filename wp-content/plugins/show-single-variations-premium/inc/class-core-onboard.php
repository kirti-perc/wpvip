	...
	public static function get_onboard_steps_display() {
		...
		<ul class="iconic-onboard-steps">
			...
			<li class="iconic-onboard-steps__step">
				...
				<a href="https://iconicwp.com/support/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wssv&utm_content=get-started" class="iconic-onboard-steps__step-link">
